...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14133 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14133 = (function (val,box,meta14134){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14133.cljs$lang$type = true;
cljs.core.async.impl.channels.t14133.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14133";
cljs.core.async.impl.channels.t14133.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write(writer__4049__auto__,"cljs.core.async.impl.channels/t14133");
});
cljs.core.async.impl.channels.t14133.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14133.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14135){var self__ = this;
var _14135__$1 = this;return self__.meta14134;
});
cljs.core.async.impl.channels.t14133.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14135,meta14134__$1){var self__ = this;
var _14135__$1 = this;return (new cljs.core.async.impl.channels.t14133(self__.val,self__.box,meta14134__$1));
});
cljs.core.async.impl.channels.__GT_t14133 = (function __GT_t14133(val__$1,box__$1,meta14134){return (new cljs.core.async.impl.channels.t14133(val__$1,box__$1,meta14134));
});
}
return (new cljs.core.async.impl.channels.t14133(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14136 = self__.takes.pop();if((taker_14136 == null))
{} else
{if(taker_14136.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_14137 = taker_14136.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_14137,taker_14136,this$__$1){
return (function (){return (take_cb_14137.cljs$core$IFn$_invoke$arity$1 ? take_cb_14137.cljs$core$IFn$_invoke$arity$1(null) : take_cb_14137.call(null,null));
});})(take_cb_14137,taker_14136,this$__$1))
);
} else
{}
{
...
var putter_14138 = self__.puts.pop();if(!((putter_14138 == null)))
{var put_handler_14139 = putter_14138.handler;var val_14140 = putter_14138.val;if(put_handler_14139.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var put_cb_14141 = put_handler_14139.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);var __14142__$1 = handler.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (put_cb_14141,__14142__$1,put_handler_14139,val_14140,putter_14138,_,retval,this$__$1){
return (function (){return (put_cb_14141.cljs$core$IFn$_invoke$arity$1 ? put_cb_14141.cljs$core$IFn$_invoke$arity$1(true) : put_cb_14141.call(null,true));
});})(put_cb_14141,__14142__$1,put_handler_14139,val_14140,putter_14138,_,retval,this$__$1))
);
self__.buf.cljs$core$async$impl$protocols$Buffer$add_BANG_$arity$2(null,val_14140);
} else
{{
continue;
}
