...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14036 = 0;while(true){
if((i_14036 < arr.length))
{(arr[i_14036] = null);
{
...
{var i_14043 = (self__.level + 1);while(true){
if((i_14043 <= (new_level + 1)))
{(update[i_14043] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14045 = 0;while(true){
if((i_14045 <= self__.level))
{var links_14046 = (update[i_14045]).forward;if(((links_14046[i_14045]) === x__$1))
{(links_14046[i_14045] = (x__$1.forward[i_14045]));
{
